...
namespace ClasificacionPeliculas.Controllers
{
    public class MoviesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Duration,Director,Actors,Plot,Rating,Votes,PosterUrl,ImdbId")] Models.Movie movie)
        {
            MoviesContext _context = new MoviesContext();
            if (id != movie.Id)
            {
        ...
        public JsonResult GetMovieJson()
        {
            ...
            var movie = (from m in _moviesContext.Movies
                                        where m.Id == movieId
